document.addEventListener("DOMContentLoaded", function () {
    ...
    function resizeCharts() {
        ...
        const charts = [window.complaints7DaysBarChart, window.allTimePieChart];
    ...
    // Initial chart setup
    document.addEventListener('DOMContentLoaded', function() {
        const barChartCanvas = document.getElementById('complaints7DaysBarChart');
        const pieChartCanvas = document.getElementById('allTimePieChart');
        
        if (barChartCanvas && window.complaints7DaysBarChart) {
            window.complaints7DaysBarChart.options = {
                ...window.complaints7DaysBarChart.options,
                ...chartOptions
            };
            window.complaints7DaysBarChart.update();
        }
        
        if (pieChartCanvas && window.allTimePieChart) {
            window.allTimePieChart.options = {
                ...window.allTimePieChart.options,
                ...chartOptions
            };
            window.allTimePieChart.update();
        }
    ...
    fetchAndUpdateStatistics(document.getElementById('filterPeriod').value);
